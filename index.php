...
if(isset($_GET['share']) ){ ?>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        sureliBasariliMesajiGoster(1500,'Paylasma İslemi');
    });
    </script>
<?php }
            ...
            <div class=" akis   col-lg-9 col-md-8  rounded" style=" text-align:center;">
                ...
                <div class="row">
                    <div class="gonderi mb-5 container mt-2 rounded  ">
                        <form action="admin/routes/shareRouter.php" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
                                <input class="form-control" name="title" rows="4" placeholder="Başlık"/>
                            </div>
                            <div class="mb-3">
                                <textarea class="form-control" name="content" rows="4" placeholder="Günün Konusu"></textarea>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="post-button">
                                    <button type="submit" name="share" class="btn btn-primary">Paylaş</button>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="col-lg-9">
                            <article class="post-grid mb-5">
                                <a class="post-thumb mb-4 d-block" href="detay.php?postid=<?= $dt['id'] ?>">
                                    <img src="<?= str_replace('../admin/', '', $imagePath); ?>" alt="" class="img-fluid">

                                </a>
                                <span class="font-sm text-color letter-spacing text-uppercase post-meta font-extra"> <?= $cat ?></span>
                                <h3 class="post-title mb-1 mt-2"><a href="detay.php?postid=<?= $dt['id'] ?>"><?= $titleContent ?></a></h3>
                ...
                <div class="sidebar sidebar-right">
                    <div class="sidebar-wrap mt-5 mt-lg-0">
                        <div class="sidebar-widget about mb-5 text-center p-3">
                            ...
                            <blockquote>
                                <i class="ti-quote-left mr-2"></i>Nolur Bizi Mezun Edin<i class="ti-quote-right ml-2"></i>
                            </blockquote>
                        </div>
